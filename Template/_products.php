        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <form action="" class="form-row pt-4 font-size-16 font-baloo">
                    <div class="col">
                        <button class="btn btn-danger form-control">Mua hàng</button>
                    </div>
            ...
            <div class="col-sm-6 py-5">
                ...
                <div class="d-flex">
                    ...
                    <a href="#" class="px-2 font-rale font-size-14">20,534 rating | 1000+ answered question</a>
                </div>
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td>$<span class="text-danger font-size-16">152.00</span></td>
                    </tr>
                </table>
                <!-- product price -->
                ...
                <div id="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">Daily Tuition <br />
                                Delivery</a>
                        </div>
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">1 Year <br />
                                Warranty</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                ...
                <p class="font-rale font-size-14">
                    ...
                    Suscipit earum quisquam reprehenderit nihil, cupiditate laborum?
                    Veniam doloribus, magni labore, eligendi cumque neque quaerat
                    incidunt, dolore quibusdam commodi nihil tempora doloremque.
                    <br />
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Suscipit earum quisquam reprehenderit nihil, cupiditate laborum?
                    Veniam doloribus, magni labore, eligendi cumque neque quaerat
